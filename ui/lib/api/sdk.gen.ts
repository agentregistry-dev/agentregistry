 ...
 */
export const pluginMarketplaceGet = <ThrowOnError extends boolean = false>(options?: Options<PluginMarketplaceGetData, ThrowOnError>) => (options?.client ?? client).get<PluginMarketplaceGetResponses, PluginMarketplaceGetErrors, ThrowOnError>({ url: '/plugin-marketplace/marketplace.json', ...options });

...
// Eitan: we should be doing authz checks here + tell list servers to filter based on what user has access to.
// May be worth design meeting to discuss. authz check here, in case of list have set of filters.

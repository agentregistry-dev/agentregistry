-- Drop the v1alpha1 semantic-embedding columns, HNSW indexes, and the
-- pgvector extension left over from the removed semantic-search feature.
--
...
-- columns/indexes never existed and the extension was never installed)
-- and on installs that ran with it true (003_embeddings.sql had
-- created them).

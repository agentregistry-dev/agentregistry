...
// control-plane events wired for the Deployment controller's dependency
// handling (migration 011).
func TestStore_ModelMutableObjectCRUD(t *testing.T) {
	...
	// The models table records control-plane events so Model edits wake
	// the Deployment controller like every other dependency kind.

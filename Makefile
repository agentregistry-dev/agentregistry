...
# Run Go tests with integration tests. Requires Postgres (start via
# `make run-docker`, or point AGENT_REGISTRY_TEST_DATABASE_URL elsewhere);
# tests fail when it is unreachable.
.PHONY: test
